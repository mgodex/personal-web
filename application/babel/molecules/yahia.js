...
var Yahia = {
	load: function(source) {
		var imgData;
		if(source == 'home') imgData = 'includes/images/mgod.png';
		else if(source == 'bucket') imgData = 'includes/images/mgod.png';
		else if(source == 'projectsAll') imgData = 'includes/images/mgod.png';
		else if(source == 'thoughtsAll') imgData = 'includes/images/mgod.png';
		else if(source == 'notFound') imgData = 'includes/images/mgod.png';
